...
let arrActor = ["Click", "Zohan", "Little Nicky", "Happy Gilmore", "Anger Management", "Spanglish", "The Wedding Singer"];

const container = document.getElementById("movie"); //para visualizar en container
let randomNumb = Math.floor((Math.random() * arrActor.length - 1) + 1); //numero aleatorio segun elementos del array
let randomMov = arrActor[randomNumb]; //el número representa una pelicula
        ...
        container.innerHTML += `
	  	        <div class="row">
                   ...
                   <h3>Sinopsis</h3>
                    ...
                    <a href="actor2.html" title="Información peliculas" class="navbar-brand">Siguiente</a>
	  	           </div>
	  	        </div>
	  	        <div class="row">
          <div class="well">
